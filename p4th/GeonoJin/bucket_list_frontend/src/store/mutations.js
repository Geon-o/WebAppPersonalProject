...
export default {
    ...
    [REQUEST_BUCKET_LIST_BY_CURRENT_USER_NICKNAME_PER_PAGE_FROM_SPRING](state, passingData) {
        state.myBucketListTotalPage = passingData
    },
    [REQUEST_SEARCH_BUCKET_LIST_TOTAL_PAGE_FROM_SPRING](state, passingData) {
        state.searchBucketListTotalPageValue = passingData
    },
}